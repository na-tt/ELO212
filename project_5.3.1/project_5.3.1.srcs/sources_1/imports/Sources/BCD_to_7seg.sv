...
module BCD_to_sevenSeg(
    ...
    always_comb begin
        case(BCD_in)
            ...
            4'd10:  sevenSeg = ~7'b1110111; // we will display hexadecimal digits as well
            ...
            default:sevenSeg = ~7'b0000001; // shows a line
            // bitwise negations because it was originally intended for common cathode display
        endcase
   end
endmodule
