...
HD_PWD='C:/Users/Natt/ELO212/project_5.3.1/project_5.3.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_BCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_BCD.tcl -notrace
