...
HD_PWD='C:/Users/Natt/ELO212/project_5.3.3/project_5.3.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fib_seq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fib_seq.tcl -notrace
