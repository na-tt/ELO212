...
HD_PWD='C:/Users/Natt/ELO212/project_5.3.3/project_5.3.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fib_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fib_seq.tcl
