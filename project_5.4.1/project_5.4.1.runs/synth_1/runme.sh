...
HD_PWD='C:/Users/Natt/ELO212/project_5.4.1/project_5.4.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log group_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source group_display.tcl
