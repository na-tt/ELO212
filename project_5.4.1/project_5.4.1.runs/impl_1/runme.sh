...
HD_PWD='C:/Users/Natt/ELO212/project_5.4.1/project_5.4.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log group_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source group_display.tcl -notrace
