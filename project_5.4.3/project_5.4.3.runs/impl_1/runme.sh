...
HD_PWD='C:/Users/Natt/Documents/GitHub/ELO212/project_5.4.3/project_5.4.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log button_counter8hex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source button_counter8hex.tcl -notrace
