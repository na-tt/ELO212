...
HD_PWD='C:/Users/Natt/ELO212/project_5.3.2/project_5.3.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_divider.tcl
