...
HD_PWD='C:/Users/Natt/ELO212/project_5.3.2/project_5.3.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_divider.tcl -notrace
