...
HD_PWD='C:/Users/Natt/Documents/GitHub/ELO212/project_5.3.4/project_5.3.4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Display_ALU.tcl -notrace
