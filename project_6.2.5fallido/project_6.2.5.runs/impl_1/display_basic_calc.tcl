...
set rc [catch {
  ...
  open_checkpoint display_basic_calc_routed.dcp
  ...
  catch { write_mem_info -force display_basic_calc.mmi }
  write_bitstream -force display_basic_calc.bit 
  catch {write_debug_probes -quiet -force display_basic_calc}
  catch {file copy -force display_basic_calc.ltx debug_nets.ltx}
