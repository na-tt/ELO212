...
HD_PWD='C:/Users/Natt/Documents/GitHub/ELO212/project_5.4.2/project_5.4.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_alu_dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_alu_dec.tcl -notrace
