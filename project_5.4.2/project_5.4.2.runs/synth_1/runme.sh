...
HD_PWD='C:/Users/Natt/Documents/GitHub/ELO212/project_5.4.2/project_5.4.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_alu_dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_alu_dec.tcl
